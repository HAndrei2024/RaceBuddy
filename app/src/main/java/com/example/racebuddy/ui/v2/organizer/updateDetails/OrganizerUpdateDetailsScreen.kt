...
@Composable
fun OrganizerUpdateDetailsScreen(
    firstNameValue: String,
    onFirstNameChange: (String) -> Unit,
    lastNameValue: String,
    onLastNameChange: (String) -> Unit,
    onNationalityTextFieldChange: (String) -> Unit,
    organizerNameValue: String,
    onOrganizerNameChange: (String) -> Unit,
    organizerIdentificationNumberValue: String,
    onOrganizerIdentificationNumberChange: (String) -> Unit,
    errorMessage: String,
    showError:Boolean,
    onDoneClick: () -> Unit,
    onBackClick: () -> Unit,
        ...
        LazyColumn(
            ...
            item {
                OrganizerNameTextField(
                    textStringValue = organizerNameValue,
                    placeholderString = "Organizer Name",
            ...
            item {
                Spacer(
                    modifier.size(paddings.spacingMedium)
                )
                FirstNameTextField(
                    textStringValue = firstNameValue,
                    placeholderString = "Administrator First Name",
                    iconImageVector = Icons.Filled.Person,
            ...
            item {
                LastNameTextField(
                    ...
                    placeholderString = "Administrator Last Name",
                    iconImageVector = Icons.Filled.Person,
            ...
            item {
                ...
                OrganizerIdentificationNumberTextField(
                    textStringValue = organizerIdentificationNumberValue,
                    placeholderString = "Identification Number",
                    iconImageVector = Icons.Filled.Info,
                    onValueChange = onOrganizerIdentificationNumberChange,
                    modifier = Modifier
                )
            }
        }
...
@Composable
fun OrganizerIdentificationNumberTextField(
    textStringValue: String,
    placeholderString: String,
    iconImageVector: ImageVector,
    onValueChange: (String) -> Unit,
...
@Preview
@Composable
fun OrganizerUpdateDetailsScreenPreview() {
    OrganizerUpdateDetailsScreen(
        ...
        organizerIdentificationNumberValue = "",
        onOrganizerIdentificationNumberChange = {},
    )
}
